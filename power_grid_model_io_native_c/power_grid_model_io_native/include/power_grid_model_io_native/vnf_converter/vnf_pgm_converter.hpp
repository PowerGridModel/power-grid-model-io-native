...
class PgmVnfConverter {
  public:
    PgmVnfConverter(char const* buffer = nullptr, power_grid_model::WritableDataset* data = nullptr,
...
inline void PgmVnfConverter::set_file_buffer(char const* file_buffer) { this->f_file_buffer = file_buffer; }

inline void PgmVnfConverter::set_deserialized_data(power_grid_model::WritableDataset* data) {
    this->deserialized_data = data;
}

inline char const* PgmVnfConverter::get_file_buffer() { return this->f_file_buffer; }
