...
inline PgmVnfConverter::PgmVnfConverter(char* buffer, power_grid_model::WritableDataset* data,
                                        power_grid_model_io_native::Idx experimental_feature_flag)
    : f_file_buffer(buffer), deserialized_data(data), experimental_feature_flag(experimental_feature_flag) {
...
inline void PgmVnfConverter::set_file_buffer(const char* file_buffer) { this->f_file_buffer = file_buffer; }

inline void PgmVnfConverter::set_deserialized_data(power_grid_model::WritableDataset* data) {
    this->deserialized_data = data;
}

inline const char* PgmVnfConverter::get_file_buffer() { return this->f_file_buffer; }
