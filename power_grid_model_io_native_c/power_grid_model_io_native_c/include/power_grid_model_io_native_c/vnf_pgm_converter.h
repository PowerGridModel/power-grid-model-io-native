 ...
 * @param handle
 * @param file_buffer A pointer to the file buffer object which holds the .vnf data.
 * @return The pointer to a PGM_VNF_converter object.
 */
 ...
 * @param handle
 * @param converter_ptr A pointer to a PGM_VNF_converter object.
 * @param dataset A pointer to the const dataset supplied by the user.
 * @return The pointer to the const dataset supplied by the user which has been filled in.
 */
